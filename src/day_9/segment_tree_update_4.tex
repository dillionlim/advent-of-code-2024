% Use kroki to convert to importable link
...
% Root node
\node [draw=red, fill=Apricot!20, text=BrickRed, thick] {%
  \begin{tabular}{c}
    \textbf{$a[0 \cdots 4]$} \\ 
    \textbf{max=4}
  \end{tabular}
  ...
  % Level 1
  child {node [draw=Violet!30, fill=CadetBlue!20, text=Violet!50, thick] {%
    \begin{tabular}{c}
      \textbf{$a[0 \cdots 2]$} \\ 
      \textbf{max=4}
    \end{tabular}
    ...
    child {node [draw=Violet!30, fill=CadetBlue!20, text=Violet!50, thick] {%
      ...
      edge from parent[thick, draw=CadetBlue!30] % Edge from [0..1] to its children
      }
      edge from parent[thick, draw=CadetBlue!30] % Edge from [0..2] to its children
    }
    child {node {%
      \begin{tabular}{c}
        $a[2 \cdots 2]$ \\ 
    ...
    edge from parent[thick, draw=red] % Edge from [0..4] to its children
  }
  child {node {%
    \begin{tabular}{c}
      $a[3 \cdots 4]$ \\ 
